...
// Source: get_user_by_id.go
//
// Generated by this command:
//
//	mockgen --source=get_user_by_id.go --destination=../mocks/get_user_by_id_interface_mock.go --package=mocks
//
...
func (m *MockGetUserByIdInterface) Do(ctx context.Context, input *app.GetUserByIdInput) (*app.GetUserByIdOutput, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGetUserByIdInterfaceMockRecorder) Do(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Do", reflect.TypeOf((*MockGetUserByIdInterface)(nil).Do), ctx, input)
}
