...
// Source: packages/encryption/encryption.go
//
// Generated by this command:
//
//	mockgen -source=packages/encryption/encryption.go -destination=services/users/mocks/encryption_interface_mock.go -package=mocks -write_generate_directive
//
...
//go:generate mockgen -source=packages/encryption/encryption.go -destination=services/users/mocks/encryption_interface_mock.go -package=mocks -write_generate_directive
